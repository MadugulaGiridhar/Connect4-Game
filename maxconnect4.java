...
public class maxconnect4
{
	public static void main(String[] args) {		
		...
		if( game_mode.equalsIgnoreCase( "interactive" ) ) 
		{
			...
			if(nextMove.equalsIgnoreCase("human-next"))
			{
				String move_1 ="human";
				...
				{
					Scanner user_Input_var = new Scanner(System.in);
					System.out.println("Please make your move.");
					int user_Input = user_Input_var.nextInt();
					while(!currentGame.playPiece(user_Input-1))
					{
						System.out.println("Invalid move!Please make valid move.");
						Scanner user_Input_Variable = new Scanner(System.in);						
						user_Input = user_Input_Variable.nextInt();
					}
